...
const ProductSection = ({ showPurchaseButton, onPurchase, onSecondaryPackageClick }: ProductSectionProps) => {
  ...
  return (
    <div className="w-full max-w-xs mx-auto px-4 mt-4 space-y-4">
      {/* Main Package - 6 Bottles */}
      <div className="relative bg-blue-500 rounded-2xl p-4 text-white shadow-xl">
        {/* Best Value Badge */}
        ...
        <div className="text-center pt-3">
          ...
          <h3 className="text-xl font-black mb-1">EAGLEBOOST</h3>
          <p className="text-white text-sm font-medium mb-2">6 BOTTLE PACKAGE</p>
          
          <p className="text-yellow-400 text-base font-bold mb-3">YOU'RE SAVING $300</p>
          
          <Button
            onClick={() => handlePurchaseClick("6-bottle")}
            variant="cta-warning"
            className="mb-3 min-h-[50px] text-sm w-full"
            id="six-bottle-package"
          >
            CLAIM OFFER NOW
          </Button>

          <p className="text-white text-sm mb-3">only $49 per bottle, $294 total</p>

          {/* Trust Badges */}
          <div className="flex justify-center gap-2 mb-3">
            <div className="bg-blue-400/30 px-2 py-1 rounded-lg flex items-center gap-1">
