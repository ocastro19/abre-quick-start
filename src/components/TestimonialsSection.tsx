...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      stars: 5,
      verified: true,
      videoIframe: `<script type="text/javascript"> var s=document.createElement("script"); s.src="https://scripts.converteai.net/lib/js/smartplayer-wc/v4/sdk.js", s.async=!0,document.head.appendChild(s); </script> <div id="ifr_68c44afb02d156008ff05b9b_wrapper" style="margin: 0 auto; width: 100%; "> <div style="position: relative; padding: 74.28571428571429% 0 0 0;" id="ifr_68c44afb02d156008ff05b9b_aspect"> <iframe frameborder="0" allowfullscreen src="about:blank" id="ifr_68c44afb02d156008ff05b9b" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" referrerpolicy="origin" onload=" this.onload=null, this.src='https://scripts.converteai.net/d37be28a-dfe1-4a86-98a2-9c82944967ec/players/68c44afb02d156008ff05b9b/v4/embed.html' +(location.search||'?') +'&vl=' +encodeURIComponent(location.href)"></iframe> </div> </div>`
    }
  ];
